    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-6 sm:py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Join thousands of global buyers sourcing from India
        </p>
      </div>
            ...
            <div className="flex items-start text-blue-700">
              ...
              <div>
                ...
                <p className="text-xs mt-1">
                  After registration, you'll receive a verification email. Please click the link in the email to verify your account before signing in.
                </p>
              </div>
            </div>
          </div>
