  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-6 py-8">
        ...
        {/* Quick Actions */}
        {/* Supplier Queries Section */}
        {queries.length > 0 && (
          <div className="mt-8 bg-orange-50 border border-orange-200 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-orange-900 mb-4">📋 Supplier Questions Need Your Response</h3>
            <div className="space-y-4">
              {queries.map((query) => (
                <div key={query.id} className="bg-white p-4 rounded-lg border border-orange-300">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h4 className="font-semibold text-gray-900">{query.rfq_title}</h4>
                      <p className="text-sm text-gray-600">Question from: {query.supplier_company}</p>
                    </div>
                  ...
                  <div className="mb-3 p-3 bg-gray-50 rounded text-sm">
                    <strong>Supplier's Question:</strong> {query.query_text}
                  </div>
