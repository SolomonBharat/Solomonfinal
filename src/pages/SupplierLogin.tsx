        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> Solomon Bharat works with pre-vetted suppliers only. 
              If you're interested in joining our supplier network, please contact us at 
              <a href="mailto:suppliers@solomonbharat.com" className="font-medium underline ml-1">
                suppliers@solomonbharat.com
              </a>
            </p>
          </div>
        </div>
